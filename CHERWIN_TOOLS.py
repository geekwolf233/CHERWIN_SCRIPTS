...
def CHECK():
    ...
    print('>>>>>>>开始获取版本信息...')
    baseurl = 'https://gh-proxy.com/https://github.com/CHERWING/CHERWIN_SCRIPTS/raw/main/'
    TOOLS_NAME = 'CHERWIN_TOOLS.py'
    server_script_url = f'https://gh-proxy.com/https://github.com/CHERWING/CHERWIN_SCRIPTS/raw/main/{TOOLS_NAME}'
    try:
        response = requests.get(f'https://gh-proxy.com/https://github.com/geekwolf233/CHERWIN_SCRIPTS/blob/main/CHERWIN_SCRIPT_CONFIG.json', verify=False)
